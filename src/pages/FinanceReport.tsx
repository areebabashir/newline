...
const FinanceReport = () => {
  ...
  const columns: ColumnDef<JobData, any>[] = [
    ...
    columnHelper.accessor('marginPercent', {
      header: 'Margin %',
      cell: (info) => (
        <span className="bg-yellow-100 text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300 px-3 py-1 rounded-full text-sm font-medium">
          {info.getValue()}
        </span>
      ),
    }),
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-6 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-yellow-600 dark:text-yellow-400 font-medium">{jobData[0].marginPercent}</span>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center py-2">
                ...
                <span className="text-yellow-600 dark:text-yellow-400 font-bold text-lg">{summary.totalVat}</span>
              </div>
              <div className="flex justify-between items-center py-2">
