...
import { Search, Download, Plus, Edit, Trash2, CheckCircle, Calendar, Truck, DollarSign, ChevronLeft, ChevronRight, MapPin } from 'lucide-react';
import {
  createColumnHelper,
  flexRender,
  getCoreRowModel,
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-6">
          <div className="flex justify-between items-center">
            ...
            <Dialog open={showAddBookingModal} onOpenChange={setShowAddBookingModal}>
                ...
                <div className="space-y-6">
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex justify-end gap-2 pt-4 border-t border-gray-200 dark:border-gray-700 mt-4">
                      ...
                      <button
                        type="submit"
                        className="px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-black rounded-lg font-medium transition-colors duration-150 text-sm dark:bg-yellow-700 dark:hover:bg-yellow-800"
                      >
        ...
        {deleteConfirm && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4" style={{ left: '320px' }}>
