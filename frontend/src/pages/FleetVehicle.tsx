...
const FleetVehicle = () => {
  ...
  const getCategoryBadge = (category) => {
    const categoryColors = {
      luxury: 'bg-amber-100 text-amber-700 dark:bg-amber-900 dark:text-amber-300',
      sedan: 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300',
      SUV: 'bg-orange-100 text-orange-700 dark:bg-orange-900 dark:text-orange-300',
      VAN: 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300',
    };
