...
const failureRecords = [
  { jobNumber: '001', jobDateTime: '2025-09-15 14:30', complainDate: '2025-09-16', passengerName: 'John Doe', driverName: 'Alice Smith', jobHandledBy: 'Team A', viewDoc: 'document1.pdf', action: 'Pending' },
  { jobNumber: '002', jobDateTime: '2025-09-14 10:15', complainDate: '2025-09-15', passengerName: 'Jane Smith', driverName: 'Bob Johnson', jobHandledBy: 'Team B', viewDoc: 'document2.pdf', action: 'Resolved' },
  { jobNumber: '003', jobDateTime: '2025-09-13 16:45', complainDate: '2025-09-14', passengerName: 'Mike Wilson', driverName: 'Carol Davis', jobHandledBy: 'Team A', viewDoc: 'document3.pdf', action: 'In Progress' },
  { jobNumber: '004', jobDateTime: '2025-09-12 09:20', complainDate: '2025-09-13', passengerName: 'Sarah Brown', driverName: 'David Lee', jobHandledBy: 'Team C', viewDoc: 'document4.pdf', action: 'Pending' },
  { jobNumber: '005', jobDateTime: '2025-09-11 13:55', complainDate: '2025-09-12', passengerName: 'Tom Anderson', driverName: 'Emma White', jobHandledBy: 'Team B', viewDoc: 'document5.pdf', action: 'Resolved' },
  { jobNumber: '006', jobDateTime: '2025-09-10 11:30', complainDate: '2025-09-11', passengerName: 'Lisa Garcia', driverName: 'James Miller', jobHandledBy: 'Team A', viewDoc: 'document6.pdf', action: 'Pending' },
];

const columnHelper = createColumnHelper();

const columns = [
  columnHelper.accessor('jobNumber', { header: 'Job Number', cell: ({ getValue }) => <span className="text-yellow-600 dark:text-yellow-400 font-medium">{getValue()}</span> }),
  ...
  columnHelper.accessor('viewDoc', {
    header: 'View Doc',
    cell: ({ getValue }) => (
      <a href="#" onClick={(e) => { e.preventDefault(); console.log('Viewing document:', getValue()); }} className="text-yellow-600 dark:text-yellow-400 hover:underline">
        View
      </a>
    ),
  }),
...
const SummaryCard = ({ title, value, color, Icon }) => {
  ...
  const colorClasses = {
    green: 'bg-yellow-100 text-yellow-600 dark:bg-yellow-900/30 dark:text-yellow-400',
    orange: 'bg-orange-100 text-orange-600 dark:bg-orange-900/30 dark:text-orange-400',
    blue: 'bg-amber-100 text-amber-600 dark:bg-amber-900/30 dark:text-amber-400',
    purple: 'bg-yellow-100 text-yellow-600 dark:bg-yellow-900/30 dark:text-yellow-400',
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-6">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Service Failure Records</h1>
...
export default ServiceFailureRecords;