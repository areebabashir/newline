    ...
    columnHelper.accessor('driverName', {
      ...
      cell: (info) => (
        <div className="max-w-[150px]">
          <span className="text-yellow-600 dark:text-yellow-400 font-medium hover:text-yellow-800 dark:hover:text-yellow-300 cursor-pointer block truncate" title={info.getValue()}>
            {info.getValue()}
          </span>
          <span className="text-gray-500 dark:text-gray-400 text-sm truncate block" title={info.row.original.driverId}>
