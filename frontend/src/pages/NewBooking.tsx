...
const NewBooking = () => {
  ...
  const handleSubmit = () => {
    const newBooking = {
      ...
      bookingType: (formData.journeyType === 'one-way' ? 'point-to-point' : formData.journeyType) as 'point-to-point' | 'hourly' | 'full-day',
      status: 'pending' as const,
      scheduledTime: new Date(`${formData.pickUpDate}T${formData.pickUpTime}`).toISOString(),
      fare: 0,
            ...
            <DialogContent className="max-w-3xl max-h-[75vh] overflow-y-auto z-[100]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-yellow-600 underline cursor-pointer mt-2">Available Namecard In Account</p>
                  </div>
                </div>
              ...
              <div className="border-t pt-6">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="flex gap-2">
                    <Button variant="link" className="text-yellow-600 text-sm">+ Preset Booker</Button>
                    <Button variant="link" className="text-yellow-600 text-sm">+ Quick Add</Button>
                  </div>
                </div>
                <div className="space-y-3">
                  ...
                  <Button variant="outline" className="w-fit text-yellow-600 border-yellow-600">+ Additional Booker</Button>
                </div>
              </div>
              ...
              <div className="border-t pt-6">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="flex gap-2">
                    <Button variant="link" className="text-yellow-600 text-sm">+ Preset Passenger</Button>
                    <Button variant="link" className="text-yellow-600 text-sm">+ Quick Add</Button>
                  </div>
                </div>
                <div className="space-y-3">
                  ...
                  <Button variant="outline" className="w-fit text-yellow-600 border-yellow-600">+ Additional Passenger</Button>
                </div>
              </div>
              ...
              <div className="border-t pt-6">
                ...
                <div className="space-y-4">
                  ...
                  <Button variant="link" className="text-yellow-600 text-sm w-fit">+ Add Via</Button>
                  <div>
                ...
                <div className="border-t pt-6 flex justify-end gap-4">
                  ...
                  <Button className="bg-yellow-600 hover:bg-yellow-700 text-black px-8" onClick={handleSubmit}>
                    Create Booking
                  </Button>
                </div>
              </div>
