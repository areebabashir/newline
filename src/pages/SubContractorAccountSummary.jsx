...
const SubContractorAccountSummary = () => {
  ...
  const columns = useMemo(() => [
    ...
    columnHelper.accessor('accountPayableContact', {
      ...
      cell: (info) => <span className="text-gray-700 dark:text-gray-300 text-sm truncate block max-w-[150px]" title={info.getValue() || '-'}>{info.getValue() || '-'}</span>,
    }),
  ...
  return (
    <>
      <div className="h-screen flex flex-col bg-gray-50 dark:bg-gray-900 overflow-hidden">
        <div className="flex-1 flex flex-col max-w-7xl mx-auto w-full p-6 space-y-6 overflow-hidden">
          {/* Header Container */}
