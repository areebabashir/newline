...
const TFLReportSummary = () => {
  ...
  const columns = [
    columnHelper.accessor('jobNo', {
      header: 'JOB NO.',
      cell: (info) => <span className="text-yellow-600 dark:text-yellow-400 font-medium hover:text-yellow-800 dark:hover:text-yellow-300 cursor-pointer">{info.getValue()}</span>,
    }),
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="bg-yellow-500 hover:bg-yellow-600 text-black px-4 py-2 rounded-lg font-medium flex items-center gap-2 transition-all duration-200"
                >
                  <Plus size={18} />
                  Add Job
                </button>
