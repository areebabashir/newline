...
import { Search, Plus, Download, Edit, Trash2, Calendar, MapPin, Info, Truck, DollarSign, ChevronLeft, ChevronRight } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogHeader,
          ...
          <div className="flex justify-between items-center">
            ...
            <Dialog open={showAddJobModal} onOpenChange={setShowAddJobModal}>
              <DialogTrigger asChild>
                <Button className="bg-yellow-500 hover:bg-yellow-600 text-black px-4 py-2 md:px-6 md:py-3 rounded-full font-medium flex items-center gap-2 shadow-lg transition-all duration-200 hover:scale-105 dark:bg-yellow-700 dark:hover:bg-yellow-800">
                  <Plus size={20} />
                  Add Job
                </Button>
              </DialogTrigger>
                ...
                <div className="space-y-6">
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex justify-end gap-3 pt-6">
                      ...
                      <button
                        type="submit"
                        className="px-6 py-3 bg-yellow-500 hover:bg-yellow-600 text-black rounded-xl font-medium transition-colors duration-200 dark:bg-yellow-700 dark:hover:bg-yellow-800"
                      >
