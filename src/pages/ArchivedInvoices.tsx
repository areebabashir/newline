      ...
      <div className="max-w-7xl mx-auto p-6 space-y-6">
        ...
        <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-sm font-semibold text-yellow-900 dark:text-yellow-300 mb-1">Archive Information</h3>
                ...
                <tbody>
                  {paginatedInvoices.map((invoice) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-6">
                        <span className="font-semibold text-yellow-600 dark:text-yellow-400">{formatCurrency(invoice.gross)}</span>
                      </td>
                      <td className="py-4 px-6">
                      ...
                      <td className="py-4 px-6">
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="p-2 text-yellow-600 hover:text-yellow-700 dark:text-yellow-400 dark:hover:text-yellow-300 hover:bg-yellow-50 dark:hover:bg-yellow-900/30 rounded-lg transition-colors duration-200"
